...
| Does a 10B carved-int8 artifact exist and compute correctly? | **Yes:** E63 Part A, exact arithmetic/parity. Part B is hash-pinned and CONFIG-gated; its latest 2026-09-16 preflight refused before timing because 21/45 occupancy samples breached the strict bar (median 4.107830551989733%, p75 10.718789407314%, min 0.3916449086161844%, max 25.130208333333336%). Clean rate is still owed. | canonical E63 §15 / `e63_part_b_preflight.json` |
...
- Do not count E63's 2026-09-16 preflight refusal as a timing attempt: no cell ran and canonical `e63_part_b.json` was absent. The runner’s committed blob was unchanged at observed HEAD `e865abc60e002dd2aced12faa13081a83ab885b3`; reuse it at the next quiet window and do not repeat Part A/parity/interim as substitutes.
...
| E63 interim/addenda | paired int8/packed ratio in contended run ≈0.9826 corrected; composed estimate ≈49 tok/s, CI ~45.5–51.1; no absolute claim. Addendum D pins runner/engine/artefacts/sidecars and gates every future `CONFIG`. The latest 2026-09-16 45 s preflight refused at 21/45 breaches (median 4.107830551989733%, p75 10.718789407314%, min 0.3916449086161844%, max 25.130208333333336%), before any cell; `e63_part_b.json` remains absent and `G-E63d` is unattempted/VOID/OWED. | a genuinely quiet window is still required; reuse the committed runner, not earlier controls |
...
3. **Get a genuinely quiet 10–15 minute CPU window for `G-E63d`:** its 45 s all-samples guard must pass before timing. The 2026-09-16 refusal ran zero cells and is not a result.
