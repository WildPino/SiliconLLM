...
**Prossima decisione:** il manifest degli offset è coerente e chiuso; il prossimo gate è valutare se costruire un estrattore/format separato da ~1,614 GB, con parità dei tensori, un reference MTP corretto e verifica speculativa sullo **stesso** checkpoint base. Prima del download, prezzare RAM/disk e costi del base accoppiato: il solo sidecar non genera token né dimostra l'accettazione. Nessun rate/quality gate passa grazie al solo manifest. Non scaricare 22,96 GB BF16 né lanciare `convert_hf_to_gguf.py --mtp` come scorciatoia.
