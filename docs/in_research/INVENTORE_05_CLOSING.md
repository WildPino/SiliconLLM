...
|---|---|---|---|
| S1 | structured projections | **COMPLETE: G1 PASS + 3-seed C1 ADOPTED (2026-07-19)** | **r=26 beats dense in 3/3 seeds, mean Δ −0.0095 (≈3.5× ctl seed-σ) at 17.6% of x_proj bytes**; r52 neutral (C2); ordering monotone, r26 the most seed-stable arm (σ 0.0007). Post-hoc had predicted +0.053 at r=26 — pessimistic by ~0.06. Trained-product PR ≈ 7-9 → r=16 = next probe point. v1 untouched; adoption = rung-boundary A/B. Tables `INVENTORE_02` §6/§6b, chart `assets/s1_xproj_chart.png` |
